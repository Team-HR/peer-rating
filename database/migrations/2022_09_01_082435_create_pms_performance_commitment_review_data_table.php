...
class CreatePmsPerformanceCommitmentReviewDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pms_performance_commitment_review_data', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pms_performance_commitment_review_data');
    }
}
