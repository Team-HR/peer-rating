      ...
      <template #content>
        ...
        <template v-for="(office, i) in offices" :key="office.id">
          <Button
            ...
            @click="
              $inertia.get(
                `/pms/peer-rating-2022/${department.id}/peer-rating/${office.id}/peers`
              )
            "
          ...
          >
            <template #body="slotProps">
              ...
              <Button
                ...
                @click="
                  $inertia.get(
                    `/pms/peer-rating-2022/${department.id}/peer-rating/${slotProps.data.id}/peers`
                  )
                "
              ></Button>
              <Button
