    ...
    <auth-layout>
        <div class="fluid m-auto ">
            ...
            <Card>
                <template #content>
                    <DataTable :value="user" responsiveLayout="scroll" stripedRows selectionMode="single"
                        ...
                        <Column v-for="col in columns" :field="col.field" :header="col.header" :key="col.id">
                        </Column>
                        <Column field="" header="">
            ...
            <Dialog header="Account Infomation" v-model:visible="display" :modal="true"
                :breakpoints="{ '960px': '75vw', '640px': '100vw' }" :style="{ width: '50vw' }" class="mydialog">
                <div class="grid ">
                    <div class="col-12 col-md-4">
                        <h4>Last Name:</h4>
                        <InputText type="text" v-model="selectedAccount.lname" disabled class="w-auto " />
                    </div>
                    <div class="col-12 col-md-4">
                        <h4>First Name:</h4>
                        <InputText type="text" v-model="selectedAccount.fname" disabled class="w-auto " />
                    </div>
                    <div class="col-12 col-md-4">
                        <h4>M.I:</h4>
                        <InputText type="text" v-model="selectedAccount.ml" disabled class="w-auto " />
                    </div>
                    <div class="col-12">
                        <h4>Gender:</h4>
                        <InputText type="text" v-model="selectedAccount.gender" disabled class="w-auto" />
                    </div>
                    <div class="col-12">
                        <h4>Employment Status:</h4>
                        <InputText type="text" v-model="selectedAccount.status" disabled class="w-auto" />
                    </div>
                    <div class="col-12">
                        <h4>Username:</h4>
...
export default {
    data() {
        return {
            ...
            categories: [
                { name: 'Administrative Officer-in-charge if RMS Encodinf per department', key: 'A' },
                { name: 'PMT', key: 'M' },
