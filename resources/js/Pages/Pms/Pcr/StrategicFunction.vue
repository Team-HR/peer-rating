    ...
    <Card class="w-full">
      <template #title>
        ...
        <span class="uppercase"
          ><i class="bi bi-book mr-2"></i> PERFORMANCE COMMITMENT AND REVIEW | Strategic
          Function</span
        ></template
      >
      <template #subtitle>
      ...
      <template #content>
                ...
                <tr v-for="(row, index) in rows" :key="index">
                  ...
                  <td class="text-center">
                    ...
                    <Button
                      label="Delete"
                      icon="bi bi-x"
                      class="p-button-sm p-button-text p-button-danger p-2 m-1"
        ...
        <Dialog
          header="Accomplish Strategic Function"
          v-model:visible="accomplishment_modal"
          :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
          :style="{ width: '50vw' }"
          :modal="true"
        >
          <form
            @submit.prevent="submit_add_edit_accomplishment()"
            id="add_edit_accomplishment_form"
          >
            <div class="field">
              <div class="font-bold mb-2">Strategic Function:</div>
              <Textarea
                v-model="accomplishment.function_title"
                :autoResize="true"
                rows="2"
                class="w-full"
                placeholder="Enter the strategic function"
                required
              />
            </div>
            <div class="field">
              ...
              <Textarea
                v-model="accomplishment.success_indicator"
                :autoResize="true"
                rows="2"
                class="w-full"
            ...
            <div class="field">
              ...
              <Textarea
                v-model="accomplishment.actual_accomplishment"
                :autoResize="true"
                rows="2"
                class="w-full"
                placeholder="Enter your actual accomplishment"
                required
              />
            </div>
            <div class="field">
              ...
              <InputNumber
                v-model="accomplishment.final_numerical_rating"
                mode="decimal"
                :minFractionDigits="2"
                :maxFractionDigits="2"
                placeholder="e.g. 1.00 - 5"
                required
              />
            </div>
          </form>
          ...
          <template #footer>
            <Button
              label="Cancel"
              icon="pi pi-times"
              @click="cancel_add_edit_accomplishment()"
              class="p-button-text"
            />
            <Button
              label="Save"
              ...
              autofocus
              type="submit"
              form="add_edit_accomplishment_form"
            />
          </template>
        </Dialog>
